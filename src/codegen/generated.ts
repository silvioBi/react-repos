...
export function useReposQuery(
  baseOptions?: Apollo.QueryHookOptions<ReposQuery, ReposQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ReposQuery, ReposQueryVariables>(
    ReposDocument,
    options
  );
}
export function useReposLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ReposQuery, ReposQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ReposQuery, ReposQueryVariables>(
    ReposDocument,
    options
  );
}
